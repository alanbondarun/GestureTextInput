...
public class WatchSettingsAdapter extends BaseAdapter
{
    private ArrayList<SettingItem> m_items = new ArrayList<>();

    public WatchSettingsAdapter()
    {
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup)
    {
        ...
        if (view == null)
        {
            ...
            view = inflater.inflate(R.layout.watch_setting_item, viewGroup, false);
        }

        SettingItem item = m_items.get(i);

        TextView txt_name = (TextView) view.findViewById(R.id.ws_item_name);
        txt_name.setText(item.getTitle());

        TextView txt_value = (TextView) view.findViewById(R.id.ws_item_value);
